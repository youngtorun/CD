	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/cd/CartItemServlet?method=batchDelete&cartItemIds=" + id;
			}
		} else {
...
function batchDelete() {
	...
	location = "/cd/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="70px">
			<a class="linkImage" href="<c:url value='/jsps/cd/desc.jsp'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.cd.image_b }'/>"/></a>
		</td>
		<td align="left" width="400px">
		    <a href="<c:url value='/jsps/cd/desc.jsp'/>"><span>${cartItem.cd.bname }</span></a>
		</td>
		<td><span>&yen;<span class="currPrice">${cartItem.cd.currPrice }</span></span></td>
		<td>
	...
	<tr>
		<td colspan="7" align="right">
			<a href="javascript:jiesuan();" style="font-size:15px" >结算</a>
		</td>
	</tr>
</table>
