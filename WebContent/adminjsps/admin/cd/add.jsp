...
<html>
  <head>
    <title>My JSP 'cddesc.jsp' starting page</title>
	...
	-->
<link rel="stylesheet" type="text/css" href="<c:url value='/adminjsps/admin/css/cd/add.css'/>">
...
$(function () {
	...
	$("#btn").click(function() {
		...
		if(!bname || !currPrice || !price || !discount || !singer || !press || !pid || !cid || !image_w || !image_b) {
			alert("图名、当前价、定价、折扣、歌手、版本、1级分类、2级分类、大图、小图都不能为空！");
			return false;
		}
...
function loadChildren() {
  ...
  <div>
   ...
   <form action="<c:url value='/admin/AdminAddCdServlet'/>" enctype="multipart/form-data" method="post" id="form">
    <div>
	    <ul>
	    	<li>唱片名：　<input id="bname" type="text" name="bname" value=" " style="width:500px;"/></li>
		...
		<table>
			<tr>
				<td colspan="3">
					歌手：　　<input type="text" id="singer" name="singer" value="Craig Walls" style="width:150px;"/>
				</td>
			</tr>
			<tr>
				<td colspan="3">
					版本：　<input type="text" name="press" id="press" value="英文版" style="width:200px;"/>
				</td>
			</tr>
			<tr>
				<td colspan="3">发行时间：<input type="text" id="publishtime" name="publishtime" value="2013-6-1" style="width:100px;"/></td>
			</tr>
			<tr>
				<td>版次：　　<input type="text" name="edition" id="edition" value="1" style="width:40px;"/></td>
				<td>歌数：　　<input type="text" name="sNum" id="sNum" value="374" style="width:50px;"/></td>
				<td>字数：　　<input type="text" name="wordNum" id="wordNum" value="48700" style="width:80px;"/></td>
			</tr>
			<tr>
				<td width="250">演唱时间：<input type="text" name="printtime" id="printtime" value="2013-6-1" style="width:100px;"/></td>
				<td width="250">时长：　　<input type="text" name="tlength" id="tlength" value="2" style="width:30px;"/>小时</td>
				<td>材质：　　<input type="text" name="paper" id="paper" value="黑胶" style="width:80px;"/></td>
			</tr>
			<tr>
				<td>
...
<c:forEach items="${parents }" var="parent">
			...
			<tr>
				<td>
					<input type="button" id="btn" class="btn" value="新唱片上架">
				</td>
				<td></td>
				<td></td>
			</tr>
