$(function() {
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/cd/images/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", "/cd/images/regist1.jpg");
		}
	);
...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/cd/UserServlet",//要请求的servlet
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url:"/yyr/UserServlet",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/cd/VerifyCodeServlet?a=" + new Date().getTime());
}
