...
<body>
	...
	<div id="box">
		<ul>
			...
			<li class="img-li"><img src="../cd_img/cyx.jpg"></li>
			<li class="img-li"><img src="../cd_img/zgr.jpg"></li>
			<li class="img-li"><img src="../cd_img/tl.jpg"></li>
			<li class="img-li"><img src="../cd_img/xch.jpg"></li>
		</ul>
