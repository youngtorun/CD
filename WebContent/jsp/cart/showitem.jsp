...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
	<tr bgcolor="#000">
		<td width="400px" colspan="5"><span style="font-weight: 900; font-color:#fff">生成订单</span></td>
	</tr>
	<tr align="center">
		<td width="10%">&nbsp;</td>
		<td width="50%">唱片名称</td>
...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td>&yen;${cartItem.cd.currPrice }</td>
	...
	<tr>
		<td colspan="5" bgcolor="#000"><span style="font-weight: 900">收货地址</span></td>
	</tr>
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="宁波市 浙江万里学院 赵阳锐"/>
		</td>
	</tr>
	<tr>
		<td style="border-top-width: 4px;" colspan="5" align="right">
			<a href="javascript:$('#form1').submit();">提交订单</a>
		</td>
	</tr>
</table>
</form>
