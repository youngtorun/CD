...
import zyr.cd.domain.CartItem;
import zyr.cd.domain.Cd;
import zyr.cd.domain.User;
...
public class CartItemDao {
	...
	public List<CartItem> loadCartItems(String cartItemIds) throws SQLException {
		 ...
		 * 3. 生成sql语句
		 */
		String sql = "select * from t_cartitem c, t_cd b where c.bid=b.bid and " + whereSql;
		/*
	...
	public CartItem findByCartItemId(String cartItemId) throws SQLException {
		String sql = "select * from t_cartItem c, t_cd b where c.bid=b.bid and c.cartItemId=?";
	...
	public void addCartItem(CartItem cartItem) throws SQLException {
		...
		Object[] params = {cartItem.getCartItemId(), cartItem.getQuantity(),
				cartItem.getCd().getBid(), cartItem.getUser().getUid()};
	...
	public List<CartItem> findByUser(String uid) throws SQLException {
		String sql = "select * from t_cartitem c, t_cd b where c.bid=b.bid and uid=? order by c.orderBy";
